...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2015/11/27 12:30:11 by adespond          #+#    #+#             */
/*   Updated: 2016/01/21 14:01:47 by adespond         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				ft_putchar_ext_fd(int c, int fd);
...
char				*ft_ultoa_base(unsigned long n, const char *s1);
